...
class TelegramDurableSupportRuntime:
    def __init__(
        self,
        *,
        private_runtime: TelegramPrivateSupportRuntime,
        transport_db_path: str | Path,
    ):
    ...
    def claim_notification(
        ...
        *,
        ...
        try:
            ...
            return self.transport.claim_notification(
    ...
    def mark_notification_delivered(
        self, *, delivery_id: str, claim_token: str, transport_message_id: str, now: float | None = None
    ) -> dict[str, Any]:
        try:
